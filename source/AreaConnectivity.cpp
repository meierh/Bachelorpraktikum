...
std::unique_ptr<AreaConnectivity::AreaConnecMap> AreaConnectivity::areaConnectivityStrengthSingleProc_Helge
(
    const DistributedGraph& graph,
...
std::unique_ptr<AreaConnectivity::AreaConnecMap> AreaConnectivity::areaConnectivityStrengthSingleProc
(
    const DistributedGraph& graph,
    unsigned int resultToRank
)
